...
async function processAutoPartsPlusPage(data: any, providerId: number) {
...
export async function getAutoPartsPlusCatalog() {
  ...
  while (hasMore) {
    ...
    await processAutoPartsPlusPage(data, providerId);
